...
CREATE TABLE `categoria_materia_prima` (
  `idCategoria_MateriaPrima` int NOT NULL AUTO_INCREMENT,
  `Nombre` varchar(45) NOT NULL,
  PRIMARY KEY (`idCategoria_MateriaPrima`)
...
INSERT INTO `categoria_materia_prima` VALUES (1,'Letras'),(2,'Dijes'),(3,'Hilo'),(4,'Cadenas'),(5,'Figuras'),(6,'Piedras'),(7,'Fimo'),(8,'Numeros'),(9,'Plásticas'),(10,'Perlas'),(11,'Ojo Turco');
...
-- Dump completed on 2022-08-12 20:07:32
